...
# ============================================================
ASCII_ART = [
    r"   JJJJJUUYXzzccunxrrjrjxCLLLLLLLQLLQQQQQQQ",
    r"   UUUUUUYYXXzcvuxuXOQCCL*OCCLCLQQLLQQQQQQQ",
    r"   UUUUUYXXXzccvJ0CX~    f&kLLQQLLQQQQQQQQQ",
    r"   YUUYYYXXzzccOc'         c*QCLQLQQQQQQQQQ",
    r"   YYXXzXzzccuJx    !_      )kJLQQLQQQQQQQQ",
    r"   XXXXzzccccuJ)   '}zU^     *JLQQQQQQQQQQQ",
    r"   zzXczccccvuuZ  l'_?Jv+Um 1aCLLQQQQQQQQQQ",
    r"   czcccccvvvurQ]Iccr:rc(Lo)p0CQLLLQQQQQQQQ",
    r"   cccccvvuuunnct[jx]^?})vOvQLLLLLLQQQQQLQQ",
    r"   vvvcvvnunnxxrnnr???nCCCUOQLLLQLLQQQQQQQQ",
    r"   vuuvuucxnjrrrjju)~](uvtnOCQLLLCLQQQQQQQQ",
    r"   uuunrnUjjcxjjf1f(+~_zU0vYcvJLQQQQQQQQQQQ",
    r"   uunxjzx)zz/)|(u0ul)f0pu?$$OYccXCOQQQQQQQ",
    r"   unuxjpcXc(/cOxMh$w<f|<]a$$$$MhZzcCQLQLLQ",
    r"   xxf)_YYZQQaMaz08]mBZm$O~aoB$$B$$aXXQLQmO",
    r"   rxxzj?}QbZMhZ0b$  $k$a $#b$M$@b$$$LcQOUz",
    r"   jr{u}tO*wZhZqhw#M h$$ r$&M$$B$##B$$CzQ[-",
    r"   {||vu0k%wZaObpbd$  $l $%$$mb$$&M$%$$um)<",
    r"   )}XUb*o#k0*0Zbhk8M Y &$#$l?1}$*#$o$$Jt]j",
    r"   }tCYoB8k#OodZ0khh$j z$o#$]!\"c$o$&M$$%1{U",
    r"   1xULM88ZBwkkUpadq%r.$#$*$%Zo$$&$k$$8$L?O",
    r"   {nYJ$$oC$pp0Ja00aanwo&B$&$$$$$&kB$&#$p u",
    r"   1jc>$*zY@bdJpqOM*kL%a$M$%B$$$$Q*$$$$$$qd",
    r"   txvcCJULhkqOp0h#kodkh@8@B%@$$$aM88o#$$$@",
]
...
def build_info_lines(stats, loc_add, loc_del, loc_total):
    ...
    return [
        ...
        f".",
        f"— Contact ———————————————————————————————————————————",
        f". Email.Personal:        your_email@gmail.com",
        f". LinkedIn:              your_linkedin",
        f". Portfolio:             your_portfolio",
        f". Discord:               your_discord",
        f".",
        f"— GitHub Stats ——————————————————————————————————————",
